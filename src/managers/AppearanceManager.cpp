...
QFont AppearanceManager::getMonoFont() const { return m_monoFont; }

QFont AppearanceManager::getUiFont() const { return m_uiFont; }

void AppearanceManager::setMonoFont(const QFont &font) { m_monoFont = font; }

void AppearanceManager::setUiFont(const QFont &font) { m_uiFont = font; }
